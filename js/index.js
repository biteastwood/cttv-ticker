...
$(function() {
  ...
  $.getJSON('https://api.coinmarketcap.com/v2/ticker/?start=1&limit=1&sort=rank&structure=array', function(data) {
      $.each(data.data, function(i, f) {
         var tblRow = "<tr>" + "<td>" + "<svg><rect width='45px' height='45px' fill='goldenrod'/><image xlink:href='https://biteastwood.github.io/cttv-ticker/SVG/"+f.symbol+".svg' width='45px' height='45px'></svg>" + "</td>" + "</tr>"
...
$(function() {
  ...
  $.getJSON('https://api.coinmarketcap.com/v2/ticker/?start=1&limit=1&sort=rank&structure=array', function(data) {
      $.each(data.data, function(i, f) {
         var tblRow = "<tr>" + "<td>" + f.rank + ") " + f.symbol + "</td>" + "</tr>" 
         + "<tr>" + "<td> $" + f.quotes.USD.price.toFixed(4) + "</td>" + "</tr>"
